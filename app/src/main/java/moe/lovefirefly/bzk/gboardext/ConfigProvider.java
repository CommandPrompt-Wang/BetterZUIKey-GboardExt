...
public class ConfigProvider extends ContentProvider {
    ...
    private static final String SOGOU_PKG = "com.google.android.inputmethod.latin";

    public static final String AUTHORITY = "moe.lovefirefly.bzk.gboardext.config";
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] projection, @Nullable String selection,
        ...
        final SharedPreferences sp = getContext()
                .getSharedPreferences(GboardConfig.PREFS_NAME, Context.MODE_PRIVATE);
        final MatrixCursor c = new MatrixCursor(new String[]{COLUMN});
        c.addRow(new Object[]{GboardConfig.dump(sp)});
        android.util.Log.i("GboardExt", "provider: dump = " + GboardConfig.dump(sp));
        return c;
    }
